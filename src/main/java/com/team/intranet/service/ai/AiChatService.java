    ...
    private String buildSystemPrompt(MemberSession ms, Member me, boolean includeBoard,
        ...
        String basePrompt = """
            ...
            • "지난주 일정", "지난달 회의", "어제 뭐 했지", "이번 주 미팅" 같은 회고형/조회 질문도
              아래 "본인 일정" 목록에서 직접 찾아 답하세요. 목록은 최근 90일 ~ 향후 60일 범위입니다.
            • 조회만 요청한 경우엔 JSON 블록을 출력하지 마세요. 본문으로만 일정을 나열하세요.
              형식 예: "지난주 일정 3건입니다.\\n• 5월 19일 (월) 14:00 ~ 15:00 부캠 회의 (회의실 A)\\n..."
            • 해당 기간에 일정이 없으면 "지난주에는 등록된 일정이 없습니다." 라고만 답하세요.
